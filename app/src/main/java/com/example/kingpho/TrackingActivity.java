...
import com.example.kingpho.adapter.FoodItemsAdapter;
...
public class TrackingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trackingSteps.add(new TrackingStep("Order Placed", "Your order has been placed.", R.drawable.order_placed, "completed"));
