    ...
    public class FavouriteAdapter extends RecyclerView.Adapter<FavouriteAdapter.FavouriteViewHolder> {
        ...
        private HashMap<Integer, Integer> favouriteIdMap;
        private UserFavouriteService userFavouriteService;

    public FavouriteAdapter(ArrayList<Product> favouritesList, HashMap<Integer, Integer> favouriteIdMap, UserFavouriteService userFavouriteService) {
                ...
                if (favouriteId != null) {
                    ...
                    call.enqueue(new Callback<Void>() {
                        ...
                        public void onFailure(Call<Void> call, Throwable t) {
                            t.printStackTrace();
                            Toast.makeText(v.getContext(), "Failed to remove from favourites: " + product.getName(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            });
