...
public class TinyDB {
    ...
    public ArrayList<Food> getListObject(String key) {
        ...
        ArrayList<Food> objects = new ArrayList<>();

        for (String jObjString : objStrings) {
            Food value = gson.fromJson(jObjString, Food.class);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListObject(String key, ArrayList<Food> objArray) {
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<>();
        for (Food obj : objArray) {
